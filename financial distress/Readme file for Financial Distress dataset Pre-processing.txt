...
- After this converting the data frame into CSV format and splitting the data into training and testing files and also appending the financial distress column having the labels '0' or '1' as the first column in the train and test CSV files.
