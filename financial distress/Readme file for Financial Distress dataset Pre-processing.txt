...
3. Finding and pre-processing my new individual dataset and pre-processing it in the following way/steps :\cb1 \uc0\u8232 \cb3 - Removing company values from the dataset.\cb1 \uc0\u8232 \cb3 - Removing the predictor variables from x2 to x83 from the dataset and taking only x1 while processing. 
...
- After this converting the data frames into CSV format and splitting the data into training and testing files.
